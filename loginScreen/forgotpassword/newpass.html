            ...
            <div class="header-left">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="../../navigations/safety.html">Safety</a></li>
    ...
    <div class="wrapper">
        <form action="/reset-password" method="POST">
            ...
            <div class="login-link">
                <p>Remember your password? <a href="/Users/alperenaksoy/Desktop/meetUp/loginScreen/loginIndex.html">Sign in</a></p>
            </div>
        </form>
    </div>
</body>
